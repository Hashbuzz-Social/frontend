...
const originalDimensions = { height: 332, width: 480 };

const WalletConnectIcon = ({ width, height, ...restProps }: SvgBaseProps) => {
  return (
    <svg fill="none" height={height ?? calculateDimensions({ originalDimensions, newWidth: width }).height} width={width ?? calculateDimensions({ originalDimensions, newHeight: height }).width} viewBox="0 0 480 332" xmlns="http://www.w3.org/2000/svg" {...restProps}>
      <path
