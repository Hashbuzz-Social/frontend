...
const Landing = () => {
  ...
  return (
    <>
      {modalState && modalState.status === "Success" && toast.success(modalState.message, { autoClose: 1500, isLoading: modalState.isLoading, position: "top-center" })}
      {modalState && modalState.status === "Error" && toast.error(modalState.message, { autoClose: 1500, isLoading: modalState.isLoading, position: "top-center" })}
      {modalState && modalState.status === "Info" && toast.warning(modalState.message, { autoClose: 1500, isLoading: modalState.isLoading, position: "top-center" })}
      <Box
        sx={{
